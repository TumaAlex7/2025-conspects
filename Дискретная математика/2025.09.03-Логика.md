...
$f = \underset{i \in I}{\bigoplus} a_i \underset{i \in I}{\prod} x_i$  
$g = \underset{i \in I}{\bigoplus} b_i \underset{i \in I}{\prod} x_i$  
$f \oplus g = \underset{i \in I}{\bigoplus} (a_i \oplus b_i) \underset{i \in I}{\prod} x_i$  
...
- Скомбинировать одинаковые мономы
  - $(\underset{i \in I}{\prod} x_i) \cdot (\underset{j \in J}{\prod} x_j) = \underset{a \in I \cup J}{\prod} x_a$
  - $x_5 \cdot x_5 = x_5$
