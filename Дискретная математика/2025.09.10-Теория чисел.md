...
$d \vdots a, n \vdots d \Rightarrow n \vdots a$ - противоречие.  
...
по утверждению есть $p \in \mathbb{P} : a \vdots p \Rightarrow p \leq a \leq \sqrt{n} \\ n \vdots p$  
...
**Опр.** *Наибольший общий делитель* (НОД) чисел $m, n \in \mathbb{Z}$, не равных одновременно нулю, — это такое наибольшее по модулю натуральное число $d$, что $d \mid m$ и $d \mid n$.  
